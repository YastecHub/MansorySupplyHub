...
namespace MansorySupplyHub.Migrations
{
    ...
    [Migration("20240813114728_Addedd OrderTable")]
    partial class AddeddOrderTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MansorySupplyHub.Dto.OrderHeaderDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MansorySupplyHub.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MansorySupplyHub.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MansorySupplyHub.Entities.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MansorySupplyHub.Dto.OrderHeaderDto", b =>
                {
                    b.HasOne("MansorySupplyHub.Entities.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MansorySupplyHub.Entities.OrderDetail", b =>
                {
                    b.HasOne("MansorySupplyHub.Dto.OrderHeaderDto", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MansorySupplyHub.Entities.ApplicationUser", null)
                        .WithMany()
