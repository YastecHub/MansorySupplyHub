...
{
    /// <inheritdoc />
    public partial class AddeddOrderTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_OrderHeaderDto_OrderHeaderId",
                        column: x => x.OrderHeaderId,
                        principalTable: "OrderHeaderDto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaderDto_CreatedByUserId",
                table: "OrderHeaderDto",
